        ...
        <div className="flex w-full h-full justify-center items-center bg-[var(--color-bg-dark)]">
            <div className="w-full max-w-md p-8 space-y-8 bg-[var(--color-bg-dark-secondary)] rounded-xl shadow-lg border border-[var(--color-border-dark)]">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-[var(--color-text-dark-secondary)]">Create a new account</p>
                </div>
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div>
                            <input
                                type="email"
                                required
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-[var(--color-border-dark)] placeholder-[var(--color-text-dark-secondary)] text-white bg-[var(--color-bg-dark)] focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] focus:z-10 sm:text-sm"
