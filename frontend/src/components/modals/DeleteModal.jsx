...
export default function DeleteModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/20 backdrop-blur-sm">
      <div className="bg-white rounded-3xl p-6 shadow-clay-card max-w-sm w-full mx-4 relative border border-gray-100">
        <button
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            ...
            disabled={loading}
            className="px-4 py-2 bg-red-500 text-white rounded-xl text-sm font-medium hover:bg-red-600 transition-colors shadow-md flex items-center gap-2"
          >
